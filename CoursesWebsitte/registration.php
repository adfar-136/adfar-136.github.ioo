...
<form class="reg-form"  method="post" action="db_insertdata.php">
   ...
   <div class="field-row">
      ...
      <select name="course" class="field form-dropdown">
         <option value="Select any"> * Select any </option>
         <option value="Game Designing Basic"> Game Designing Basic </option>
         <option value="Game Designing Advance"> Game Designing Advance </option>
         <option value="Front End Devlopment Basic"> Front End Devlopment Basic </option>
         <option value="Front End Devlopment Advance"> Front End Devlopment Advance </option>
         <option value="Python Basic"> Python Basic </option>
         <option value="Python Advance"> Python Advance </option>
         <option value="Website Designing Basics"> Website Designing Basics </option>
         <option value="Website Designing Advance"> Website Designing Advance </option>
      </select>
   </div>
   <div class="field-row">
